...
var _giaComponents = require("./js/components/GiaComponents");
var _giaComponentsDefault = parcelHelpers.interopDefault(_giaComponents);
...
const App = {
    ...
    setCSSVariables: ()=>{
        ...
        if (!App.isMobile || App.isMobile && App.lastWidth != App.width) App.container.style.setProperty("--viewport-height-init", App.height + "px");
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    slides.forEach((s, i)=>{
        ...
        s.scrollTimeline = (0, _gsap.gsap).timeline({
            defaults: {
                duration: 2
            },
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","./js/components/GiaComponents":"grzzN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"grzzN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _loadComponents = require("gia/loadComponents");
var _loadComponentsDefault = parcelHelpers.interopDefault(_loadComponents);
var _removeComponents = require("gia/removeComponents");
var _removeComponentsDefault = parcelHelpers.interopDefault(_removeComponents);
var _tinySlider = require("./gia/TinySlider");
var _tinySliderDefault = parcelHelpers.interopDefault(_tinySlider);
var _config = require("gia/config");
var _configDefault = parcelHelpers.interopDefault(_config);
const GiaComponents = {
    init: (_)=>{
        // enable components
        (0, _configDefault.default).set("log", false);
        GiaComponents.components = {
            TinySlider: (0, _tinySliderDefault.default)
        };
        GiaComponents.load();
    },
    load: (container = document.documentElement)=>{
        (0, _loadComponentsDefault.default)(GiaComponents.components, container);
    },
    unload: (container = document.documentElement)=>{
        (0, _removeComponentsDefault.default)(container);
    }
};
exports.default = GiaComponents;

},{"gia/loadComponents":"7Bz8d","gia/removeComponents":"iZW74","./gia/TinySlider":"2Msg3","gia/config":"f38z8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7Bz8d":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.default = loadComponents;
var _utils = require("c83b139d4c442da5");
var _getComponentFromElement = require("f73d4991664f500a");
var _getComponentFromElement2 = _interopRequireDefault(_getComponentFromElement);
var _createInstance = require("22d3e86c10c10b87");
 ...
 */ function loadComponents() {
    ...
    (0, _utils.queryAll)("[g-component]", context).forEach(function(element) {
        ...
        if (typeof components[componentName] === "function") initialisedComponents.push((0, _createInstance2.default)(element, componentName, components[componentName]));
...
},{"c83b139d4c442da5":"aS9wq","f73d4991664f500a":"kS65b","22d3e86c10c10b87":"b9JaR"}],"aS9wq":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
function toggleClass(element, className) {
    ...
    } else if (condition) element.classList.add(className);
    else element.classList.remove(className);
}
function removeClass(nodes, className) {
    if (Array.isArray(nodes)) nodes.forEach(function(node) {
        return node.classList.remove(className);
    });
    else nodes.classList.remove(className);
    return nodes;
}
function addClass(nodes, className) {
    ...
    else nodes.classList.add(className);
    return nodes;
}
...
},{}],"kS65b":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"b9JaR":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.default = createInstance;
var _config = require("e207f3d07e34f5b0");
 ...
 */ function createInstance(element, componentName, component, options) {
    ...
    if (_config2.default.get("log")) console.info('Created instance of component "' + componentName + '".');
    return instance;
}

},{"e207f3d07e34f5b0":"f38z8"}],"f38z8":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"iZW74":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.default = removeComponents;
var _utils = require("faecac6d7ab2c5d6");
var _destroyInstance = require("1d58561699f9828e");
...
},{"faecac6d7ab2c5d6":"aS9wq","1d58561699f9828e":"8EgFQ"}],"8EgFQ":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.default = destroyInstance;
var _getComponentFromElement = require("815463b36b82b2a9");
var _getComponentFromElement2 = _interopRequireDefault(_getComponentFromElement);
var _config = require("b34bedd0a2860950");
var _config2 = _interopRequireDefault(_config);
function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
 ...
 */ function destroyInstance(element) {
    ...
    if (instance) {
        ...
        if (_config2.default.get("log")) console.info('Removed component "' + name + '".');
    }
}

},{"815463b36b82b2a9":"kS65b","b34bedd0a2860950":"f38z8"}],"2Msg3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _component = require("gia/Component");
var _componentDefault = parcelHelpers.interopDefault(_component);
var _eventbus = require("gia/eventbus");
var _eventbusDefault = parcelHelpers.interopDefault(_eventbus);
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
class TinySlider extends (0, _componentDefault.default) {
    constructor(element){
        super(element);
        this.ref = {
            slideNumber: null
    ...
    mount() {
        this.slides = [
            ...this.element.querySelectorAll(":scope > *:not([g-ref=slideNumber]):not(.arrow)")
        ];
        ...
        (0, _eventbusDefault.default).on("Slider--play", this.play.bind(this));
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gia/Component":"gHoJf","gia/eventbus":"1I68v","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gHoJf":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
require("d0c843e9bd79b1c8");
var _BaseComponent2 = require("509704dd6a97b44");
...
},{"d0c843e9bd79b1c8":"jRGot","509704dd6a97b44":"7AuYk"}],"jRGot":[function(require,module,exports) {
/**
 ...
 * the same directory.
 */ var process = require("fc87901c758285e0");
var global = arguments[3];
!function(global) {
    "use strict";
    ...
    function makeInvokeMethod(innerFn, self1, context) {
        ...
        return function invoke(method, arg) {
            ...
            while(true){
                ...
                if (method === "next") {
                    context._sent = arg;
                    if (state === GenStateSuspendedYield) context.sent = arg;
                    else context.sent = undefined;
                ...
                if (record.type === "normal") {
                    ...
                    if (record.arg === ContinueSentinel) {
                        if (context.delegate && method === "next") // Deliberately forget the last sent value so that we don't
    ...
    Context.prototype = {
        ...
        abrupt: function(type, arg) {
            ...
            record.type = type;
            record.arg = arg;
            if (finallyEntry) this.next = finallyEntry.finallyLoc;
...
},{"fc87901c758285e0":"d5jf4"}],"d5jf4":[function(require,module,exports) {
...
},{}],"7AuYk":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var _utils = require("4724a3a0a434b0d8");
function _classCallCheck(instance, Constructor) {
    if (!(instance instanceof Constructor)) throw new TypeError("Cannot call a class as a function");
}
/**
    ...
    _createClass(Component, [
        ...
        },
        {
            ...
            value: function setState(changes) {
                ...
                Object.keys(changes).forEach(function(key) {
                    if (Array.isArray(changes[key])) {
                        if (_this._state[key] != null && Array.isArray(_this._state[key])) {
                            if (_this._state[key].length === changes[key].length) changes[key].some(function(item, index) {
                        ...
                        if (_this._state[key] != null && _typeof(_this._state[key]) === "object") {
                            ...
                            Object.keys(changes[key]).forEach(function(subkey) {
                                if (_this._state[key][subkey] !== changes[key][subkey]) stateChanges[key][subkey] = changes[key][subkey];
                            });
                        } else stateChanges[key] = changes[key];
                        _this._state[key] = _extends({}, _this._state[key], stateChanges[key]);
                    } else if (_this._state[key] !== changes[key]) {
                        stateChanges[key] = changes[key];
                ...
                Object.keys(stateChanges).forEach(function(key) {
                    if (Array.isArray(changes[key])) {
                        if (stateChanges[key].length === 0) delete stateChanges[key];
                    } else if (_typeof(changes[key]) === "object") {
                        if (Object.keys(stateChanges[key]).length === 0) delete stateChanges[key];
                    }
                });
        ...
        },
        {
            ...
            set: function set(items) {
                ...
                if (Object.keys(items).length === 0) allRefs.forEach(function(element) {
                    var refName = element.getAttribute("g-ref");
                    if (refName.indexOf(":") !== -1) {
                        var refNameArray = refName.split(":");
                        if (refNameArray[0] == _this2._name) {
                            if (!_this2._ref[refNameArray[1]]) _this2._ref[refNameArray[1]] = allRefs.filter(function(item) {
                                return item.getAttribute("g-ref") === refName;
                            });
                        } else return;
                    } else if (!_this2._ref[refName]) _this2._ref[refName] = allRefs.filter(function(item) {
                        return item.getAttribute("g-ref") === refName;
                    });
                });
                else this._ref = Object.keys(items).map(function(key) {
                    var isArray = Array.isArray(items[key]);
                    // non-empty refs
                    if (items[key] !== null && isArray && items[key].length > 0) return {
                        name: key,
                        value: items[key]
                    };
                    var name = key;
                    ...
                    if (refs.length === 0) refs = allRefs.filter(function(element) {
        ...
        },
        {
            ...
            set: function set(defaults) {
                ...
                if (optionsFromAttribute) options = JSON.parse(optionsFromAttribute);
...
},{"4724a3a0a434b0d8":"aS9wq"}],"1I68v":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var _config = require("5a140b6234bb76fb");
var _config2 = _interopRequireDefault(_config);
function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    ...
    _createClass(EventBus, [
        {
            ...
            value: function emit(event) {
                ...
                if (this.list[event]) {
                    if (_config2.default.get("log")) console.info(this.list[event].length + " handler" + (this.list[event].length > 1 ? "s" : "") + " called on event '" + event + "'");
                    this.list[event].forEach(function(handlerObject) {
                        handlerObject.handler(eventObject);
                        if (handlerObject.once) _this.off(event, handlerObject.handler);
                    });
                } else if (_config2.default.get("log")) console.info("0 handlers called on event '" + event + "'");
            }
        },
        {
            key: "on",
            value: function on(event, handler) {
                ...
                if (this.list[event]) this.list[event].push({
                    once: once,
                    handler: handler
                });
                else {
                ...
                if (event != null) {
                    if (handler != null) {
                        if (this.list[event] && this.list[event].filter(function(eventObject) {
                            ...
                            if (index > -1) this.list[event].splice(index, 1);
                        } else console.warn("Event " + event + " cannot be unsubscribed - does not exist.");
                    } else this.list[event] = [];
                } else this.list = {};
            }
        }
    ]);
...
},{"5a140b6234bb76fb":"f38z8"}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequire803e")
