    ...
    function Draggable(target, vars) {
      ...
      var type = (vars.type || "x,y").toLowerCase(),
        ...
        if (scrollProxy) {
          ...
          bounds = _getBounds(vars.bounds, target.parentNode.parentNode);
          ...
          if (rotationMode) {
            ...
            targetBounds = _getBounds(target, target.parentNode.parentNode);
        ...
        var start = matrix,
            p;
        matrix = getGlobalMatrix(target.parentNode.parentNode, true);
        ...
        if (allowNativeTouchScrolling || self.autoScroll) {
          _recordMaxScrolls(target.parentNode.parentNode);
        }

        if (target.parentNode.parentNode && self.autoScroll && !scrollProxy && !rotationMode && target.parentNode.parentNode._gsMaxScrollX && !_placeholderDiv.parentNode && !target.getBBox) {
          _placeholderDiv.style.width = target.parentNode.parentNode.scrollWidth + "px";
          target.parentNode.parentNode.appendChild(_placeholderDiv);
        }
        ...
        if (e && self.isDragging && !scrollProxy) {
          var parent = e.target || target.parentNode.parentNode,
      ...
      _this2.update = function (applyBounds, sticky, ignoreExternalChanges) {
        ...
        if (self.autoScroll) {
          _recordMaxScrolls(target.parentNode.parentNode, self.isDragging);
